...
Managed Relational Database Service (RDS) is a managed service that makes it easy to "set up", "operate", and "scale" a relational database in the cloud. RDS is available in multiple database engines, including MySQL and PostgreSQL.
